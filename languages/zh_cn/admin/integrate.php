...
$_LANG['need_not_setup'] = '当您采用XKASHOP会员系统时，无须进行设置。';
$_LANG['different_domain'] = '您设置的整合对象和 XKASHOP 不在同一域下。<br />您将只能共享该系统的会员数据，但无法实现同时登录。';
...
使用方法：
         ...
         3:如果不需要整合任何用户系统，请选择安装 xakshop 插件，即可卸载所有的整合插件。
                           </pre>';
...
$_LANG['ucenter_notice_key'] = '通信密钥用于在 UCenter 和 Xakshop 之间传输信息的加密，可包含任何字母及数字，请在 UCenter 与 Xakshop 设置完全相同的通讯密钥，以确保两套系统能够正常通信';
...
$_LANG['uc_notice_ip'] = '连接的过程中出了点问题，请您填写服务器 IP 地址，如果您的 UC 与 Xakshop 装在同一服务器上，我们建议您尝试填写 127.0.0.1';
