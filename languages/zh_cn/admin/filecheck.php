...
$_LANG['filecheck_tips_step1'] = '文件校验是针对 XKASHOP 官方发布的文件为基础进行核对，点击下面按钮开始进行校验。';
...
$_LANG['tips'] = '技巧提示: ';
$_LANG['filecheck_tips'] = '<li>“<em class="edited">被修改</em>”、“<em class="del">被删除</em>” 中的列出的文件，请即刻通过 FTP 或其他工具检查其文件的正确性，以确保XKASHOP网店功能的正常使用。</li>
