...
$_LANG['filecheck_tips_step1'] = '文件校驗是針對XKASHOP官方發布的文件為基礎進行核對，點擊下面按鈕開始進行校驗。';
...
$_LANG['tips'] = '技巧提示: ';
$_LANG['filecheck_tips'] = '<li>“<em class="edited">被修改</em>”、“<em class="del">被删除</em>” 中的列出的文件，請即刻通過FTP或其他工具檢查其文件的正確性，以確保XKASHOP網店功能的正常使用。</li>
