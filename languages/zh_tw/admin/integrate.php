...
$_LANG['need_not_setup'] = '當您採用XKASHOP會員系統時，無須進行設置。';
$_LANG['different_domain'] = '您設置的整合對像和 XKASHOP 不在同一域下。<br />您將只能共享該系統的會員數據，但無法實現同時登錄。';
...
使用方法：
         ...
         3:如果不需要整合任何用戶系統，請選擇安裝xakshop插件，即可卸載所有的整合插件。
                           </pre>';
/* 查看安裝日誌 */
...
$_LANG['ucenter_notice_key'] = '通信密鑰用於在 UCenter 和 Xakshop 之間傳輸信息的加密，可包含任何字母及數字，請在 UCenter 與 Xakshop 設置完全相同的通訊密鑰，以確保兩套系統能夠正常通信';
...
$_LANG['uc_notice_ip'] = '連接的過程中出了點問題，請您填寫服務器 IP 地址，如果您的 UC 與 Xakshop 裝在同一服務器上，我們建議您嘗試填寫 127.0.0.1';
