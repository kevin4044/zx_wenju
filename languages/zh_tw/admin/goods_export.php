...
// 批量上傳商品的字段
$_LANG['export_xakshop'] = '導出到xakshop數據格式';
$_LANG['xakshop']['goods_name'] = '商品名稱';
$_LANG['xakshop']['goods_sn'] = '商品貨號';
$_LANG['xakshop']['brand_name'] = '商品品牌';   // 需要轉換成brand_id
$_LANG['xakshop']['market_price'] = '市場售價';
$_LANG['xakshop']['shop_price'] = '本店售價';
$_LANG['xakshop']['integral'] = '積分購買額度';
$_LANG['xakshop']['original_img'] = '商品原始圖';
$_LANG['xakshop']['goods_img'] = '商品圖片';
$_LANG['xakshop']['goods_thumb'] = '商品縮略圖';
$_LANG['xakshop']['keywords'] = '商品關鍵詞';
$_LANG['xakshop']['goods_brief'] = '簡單描述';
$_LANG['xakshop']['goods_desc'] = '詳細描述';
$_LANG['xakshop']['goods_weight'] = '商品重量（kg）';
$_LANG['xakshop']['goods_number'] = '庫存數量';
$_LANG['xakshop']['warn_number'] = '庫存警告數量';
$_LANG['xakshop']['is_best'] = '是否精品';
$_LANG['xakshop']['is_new'] = '是否新品';
$_LANG['xakshop']['is_hot'] = '是否熱銷';
$_LANG['xakshop']['is_on_sale'] = '是否上架';
$_LANG['xakshop']['is_alone_sale'] = '能否作為普通商品銷售';
$_LANG['xakshop']['is_real'] = '是否實體商品';
