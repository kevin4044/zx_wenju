...
// 批量上传商品的字段
$_LANG['export_xakshop'] = 'Export to xakshop data format';
$_LANG['xakshop']['goods_name'] = '商品名称';
$_LANG['xakshop']['goods_sn'] = '商品货号';
$_LANG['xakshop']['brand_name'] = '商品品牌';   // 需要转换成brand_id
$_LANG['xakshop']['market_price'] = '市场售价';
$_LANG['xakshop']['shop_price'] = '本店售价';
$_LANG['xakshop']['integral'] = '积分购买额度';
$_LANG['xakshop']['original_img'] = '商品原始图';
$_LANG['xakshop']['goods_img'] = '商品图片';
$_LANG['xakshop']['goods_thumb'] = '商品缩略图';
$_LANG['xakshop']['keywords'] = '商品关键词';
$_LANG['xakshop']['goods_brief'] = '简单描述';
$_LANG['xakshop']['goods_desc'] = '详细描述';
$_LANG['xakshop']['goods_weight'] = '商品重量（kg）';
$_LANG['xakshop']['goods_number'] = '库存数量';
$_LANG['xakshop']['warn_number'] = '库存警告数量';
$_LANG['xakshop']['is_best'] = '是否精品';
$_LANG['xakshop']['is_new'] = '是否新品';
$_LANG['xakshop']['is_hot'] = '是否热销';
$_LANG['xakshop']['is_on_sale'] = '是否上架';
$_LANG['xakshop']['is_alone_sale'] = '能否作为普通商品销售';
$_LANG['xakshop']['is_real'] = '是否实体商品';
