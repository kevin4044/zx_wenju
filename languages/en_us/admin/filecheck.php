...
$_LANG['filecheck_tips_step1'] = 'XKASHOP check documents for the official release of the documents as the basis for cross-checking, click the button below to start checking。';
...
$_LANG['tips'] = 'Tips: ';
$_LANG['filecheck_tips'] = '<li>“<em class="edited">To be revised</em>”、“<em class="del">Deleted</em>” The list of documents, instantly, through FTP or other tools to check the validity of their documents in order to ensure the normal function of XKASHOP Shop use。</li>
