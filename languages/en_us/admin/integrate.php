...
/** The XKASHOP Control panel member the data integration plug-in management program language file
 * ----------------------------------------------------------------------------
 * All right reserved (C) 2005-2011 Beijing Yi Shang Interactive Technology
 * Development Ltd.
 * Web site: http://www.xak.cn
 * ----------------------------------------------------------------------------
...
$_LANG['need_not_setup'] = 'You needn\`t set wehn you use XKASHOP systerm';
$_LANG['neednot_sync'] ='You needn\'t synchronous operation, beacuse the XKASHOP member system is in use now.';
$_LANG['different_domain'] ='The integration object and XKASHOP of[with] your setup is not under same area.<Br/>you member\'s data that can share that system, but can\'t carry out to register in the meantime.';
...
Usage:
     ...
     3:If you do not need any user\'s system integration, please select xakshop installed plug-ins, you can uninstall all of
...
$_LANG['ucenter_notice_key'] = 'Communication key for UCenter and Xakshop information between the transmission of encrypted, can contain any letters and numbers, please UCenter with identical settings Xakshop communication key to ensure that the two systems, normal communication can';
...
$_LANG['uc_notice_ip'] = 'Some effort to connect the process of problem, please fill out the server IP address, if you have UC and Xakshop mounted on the same server, we recommend that you try to fill in 127.0.0.1';
