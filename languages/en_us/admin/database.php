...
$_LANG['unrecognize_version'] ='Can\'t identify the Xakshop version of the backup sql.';
...
$_LANG['version_error'] ='Xakshop current version the %s and the backup data version the %s is different, the backup restore failure.';
