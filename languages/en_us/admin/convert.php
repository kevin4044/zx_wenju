...
$_LANG['note_select_system'] ='(If your system not in the list, you can arrive <a href="http://www.xak.cn" target="_ blank"> <strong> our website </strong></a>look for a help).';
...
$_LANG['dir_notes'] ='Please notice root directory path of the old shop, please use opposite path of the admin directory.<Br/>For example:The old shop directory is shop in root directory, but the xakshop put in root directory, that path is../shop.';
