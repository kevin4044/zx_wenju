...
/** 超值礼包列表
 * ----------------------------------------------------------------------------
 * $File: activity.php 16056 2009-05-21 05:44:14
 */
...
$sql = "SELECT * FROM " . $xak->table('goods_activity'). " WHERE `start_time` <= '$now' AND `end_time` >= '$now' AND `act_type` = '4' ORDER BY `end_time`";
$res = $db->query($sql);
