...
--
-- 导出表中的数据 `xsp_admin_action`
--

INSERT INTO `xsp_admin_action` (`action_id`, `parent_id`, `action_code`, `relevance`) VALUES
(1, 0, 'goods', ''),
(2, 0, 'cms_manage', ''),
(3, 0, 'users_manage', ''),
(4, 0, 'priv_manage', ''),
...
--  `xsp_mail_templates`
--
INSERT INTO `xsp_mail_templates` (`template_id`, `template_code`, `is_html`, `template_subject`, `template_content`, `last_modify`, `last_send`, `type`) VALUES
...
(1769, 210, '炎陵县', 3, 0),
(1770, 211, '朝阳区', 3, 0);
INSERT INTO `xsp_region` VALUES (1771, 211, '宽城区', 3, 0),
(1772, 211, '二道区', 3, 0),
(1773, 211, '南关区', 3, 0),
(1774, 211, '绿园区', 3, 0),
(1775, 211, '双阳区', 3, 0),
...
INSERT INTO `xsp_shop_config` (`id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order`) VALUES
...
(6, 0, 'hidden', 'hidden', '', '', '', '1'),
(7, 0, 'goods', 'group', '', '', '', '1'),
(101, 1, 'shop_name', 'text', '', '', 'Xakshop', '1'),
(102, 1, 'shop_title', 'text', '', '', 'My Shop', '1'),
(103, 1, 'shop_desc', 'text', '', '', 'My Shop', '1'),
(104, 1, 'shop_keywords', 'text', '', '', 'My Shop', '1'),
...
(503, 5, 'smtp_user', 'text', '', '', 'demo_xak', '1'),
(504, 5, 'smtp_pass', 'password', '', '', 'xak888WT', '1'),
(505, 5, 'smtp_mail', 'text', '', '', 'demo_xak@163.com', '1'),
(506, 5, 'mail_charset', 'select', 'UTF8,GB2312,BIG5', '', 'UTF8', '1'),
(507, 5, 'mail_service', 'select', '0,1', '', '1', '0'),
(508, 5, 'smtp_ssl', 'select', '0,1', '', '0', '0'),
(601, 6, 'integrate_code', 'hidden', '', '', 'xakshop', '1'),
...
(606, 6, 'xsp_version', 'hidden', '', '', 'V5.0', '1'),
...
-- user_rank
--
INSERT INTO `xsp_user_rank` (`rank_id`, `rank_name`, `min_points`, `max_points`, `discount`, `show_price`, `special_rank`)
...
-- 文章默认分类
INSERT INTO `xsp_article_cat` (`cat_id`, `cat_name`, `cat_type`, `keywords`, `cat_desc`, `sort_order`, `parent_id`) VALUES (1, 'Classification system', 2, '', 'Reserved classification', 50, 0);
INSERT INTO `xsp_article_cat` (`cat_id`, `cat_name`, `cat_type`, `keywords`, `cat_desc`, `sort_order`, `parent_id`) VALUES (2, 'Online information', 3, '', 'Online information classification', 50, 1);
INSERT INTO `xsp_article_cat` (`cat_id`, `cat_name`, `cat_type`, `keywords`, `cat_desc`, `sort_order`, `parent_id`) VALUES (3, 'Online help classification', 4, '', 'Online help classification', 50, 1);

--
-- `xsp_article`
--

INSERT INTO `xsp_article` (`article_id`, `cat_id`, `title`, `content`, `author`, `author_email`, `keywords`, `article_type`, `is_open`, `add_time`, `file_url`, `open_type`) VALUES
...
INSERT INTO `xsp_template` (`filename`, `region`, `library`, `sort_order`, `id`, `number`, `type`, `theme`, `remarks`) VALUES
...
--
-- 会员注册项 xsp_reg_fields
--

INSERT INTO `xsp_reg_fields` (`id`, `reg_field_name`, `dis_order`, `display`, `type`, `is_need`) VALUES 
(1, 'MSN', 0, 1, 1, 1), 
(2, 'QQ', 0, 1, 1, 1), 
