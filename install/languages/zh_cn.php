...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2009-2012 <a href="http://www.xak.cn" target="_blank">深圳市卓睿创想科技有限公司</a> 版权所有';


/* 欢迎页 */
$_LANG['welcome_title'] = '欢迎您选用Xakshop网上商店管理系统！';
...
/* 环境检测页 */
$_LANG['checking_title'] = 'Xakshop安装程序 第2步/共3步 环境检测';
...
/* 系统设置 */
$_LANG['setup'] = '填写完毕';
$_LANG['setting_title'] = 'Xakshop安装程序 第3步/共3步 配置系统';
...
$_LANG['default_friend_link'] = 'XKASHOP 网上商店管理系统';
...
/* 提示信息 */
$_LANG['has_locked_installer'] = '<strong>安装程序已经被锁定。</strong><br /><br />如果您确定要重新安装 XKASHOP，请删除data目录下的 install.lock。';
...
$_LANG['install_done_title'] = 'XKASHOP 安装程序 安装成功';
$_LANG['install_error_title'] = 'XKASHOP 安装程序 安装失败';
$_LANG['done'] = '恭喜您，XKASHOP 已经成功地安装完成。<br />基于安全的考虑，请在安装完成后删除 install 目录。';
$_LANG['go_to_view_my_xakshop'] = '前往 XKASHOP 首页';
$_LANG['go_to_view_control_panel'] = '前往 XKASHOP 后台管理中心';
