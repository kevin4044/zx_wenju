...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2009-2012 <a href="http://www.xak.cn" target="_blank">深圳市卓睿创想科技有限公司</a> 版權所有';


/* 歡迎頁 */
$_LANG['welcome_title'] = '歡迎您選用Xakshop網上商店管理系統！';
...
/* 環境檢測頁 */
$_LANG['checking_title'] = 'Xakshop安裝程序 第2步/共3步 環境檢測';
...
/* 系統設置 */
$_LANG['setup'] = '填寫完畢';
$_LANG['setting_title'] = 'Xakshop安裝程序 第3步/共3步 配置系統';
...
$_LANG['default_friend_link'] = 'XKASHOP 網上商店管理系統';
...
/* 提示信息 */
$_LANG['has_locked_installer'] = '<strong>安裝程序已經被鎖定。</strong><br /><br />如果您確定要重新安裝 XKASHOP，請刪除data目錄下的 install.lock。';
...
$_LANG['install_done_title'] = 'XKASHOP 安裝程序 安裝成功';
$_LANG['install_error_title'] = 'XKASHOP 安裝程序 安裝失敗';
$_LANG['done'] = '恭喜您，XKASHOP 已經成功地安裝完成。<br />基於安全的考慮，請在安裝完成後刪除 install 目錄。';
$_LANG['go_to_view_my_xakshop'] = '前往 XKASHOP 首頁';
$_LANG['go_to_view_control_panel'] = '前往 XKASHOP 後台管理中心';
