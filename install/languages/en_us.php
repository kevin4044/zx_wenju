...
$_LANG['copyright'] = '&copy; 2009-2012 <a href="http://www.xak.cn" target="_blank">Xakshop</a>';


/* Welcome page */
$_LANG['welcome_title'] = 'You are welcome to use the Xakshop e-commerce management system!';
...
$_LANG['checking_title'] = 'Xakshop install program, the 2 step / 3 steps, check enviroment';
...
/* Config system */
$_LANG['setting_title'] = 'Xakshop install program, the 3 step / 3 step, config system';
...
$_LANG['default_friend_link'] = 'XKASHOP e-commerce management system';
...
/* Prompting message */
$_LANG['has_locked_installer'] = '<strong>Install program has locked.</strong><br /><br />If you confirm reinstall XKASHOP, please delete install.lock in data directory.';
...
$_LANG['install_done_title'] = 'XKASHOP install program, install successfully.';
$_LANG['install_error_title'] = 'XKASHOP install program, install failed.';
$_LANG['done'] = 'Congratulation，XKASHOP has installed successfully.<br />Based on security consideration, please delete install directory at once.';
$_LANG['go_to_view_my_xakshop'] = 'XKASHOP Homepage';
$_LANG['go_to_view_control_panel'] = 'XKASHOP Control panel';
