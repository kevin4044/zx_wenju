...
function displayres(res)
{
    if (res.error !== 0)
    {
        ...
        if(res.error == 2) {
            ...
            td2.innerHTML = '<input name=\"js-ucip\" type=\"text\" id=\"js-ucip\"  value=\"\" size=\"40\" /><span id=\"ucipnotice\" style=\"color:#FF0000\">连接的过程中出了点问题，请您填写服务器 IP 地址，如果您的 UC 与 Xakshop 装在同一服务器上，我们建议您尝试填写 127.0.0.1</span>';
