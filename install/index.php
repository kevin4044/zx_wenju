...
$_SESSION['xak_lang'] = $installer_lang;
/* 加载安装程序所使用的语言包 */
...
case 'setting_ui' :
    ...
    $_SESSION['setting_ui']['userinterface'] = empty($_GET['ui'])?'xakshop':$_GET['ui'];
    $smarty->assign('ucapi', $_POST['ucapi']);
    $smarty->assign('ucfounderpw', $_POST['ucfounderpw']);
    $smarty->assign('installer_lang', $installer_lang);
    ...
    $smarty->assign('userinterface', empty($_GET['ui'])?'xakshop':$_GET['ui']);
...
case 'do_others' :
    ...
    $integrate = isset($_POST['userinterface'])   ? trim($_POST['userinterface']) : 'xakshop';
