...
<form action="index.php?act=second" name="theForm" method="post" onsubmit="return validator()" >
  <table cellspacing="1" cellpadding="3" width="100%">
    <tr>
      ...
      <td><input type="text" class="inputText" name="shop_name" value="<?php echo $this->_var['shop_name']; ?>" /></td>
    </tr>
    <tr>
      <td class="micro-label"><?php echo $this->_var['lang']['shop_title']; ?>:</td>
      <td><input type="text" class="inputText" name="shop_title" value="<?php echo $this->_var['shop_title']; ?>" /></td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      ...
      <td><input type="text" class="inputText" name="shop_address" /></td>
    </tr>
    <tr>
        ...
        <div id="shipping_area" style="display:none">
          <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
              ...
              <td><input type="text" class="inputText" name="area_name" style="margin-bottom:5px;vertical-align:middle"></td>
            </tr>
            <tr>
