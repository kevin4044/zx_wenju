  ...
  <div id="tabbody-div">
    ...
    <table width="90%" id="general-table">
      <tr>
        ...
        <td><input type="text" class="inputText" name="title" size ="40" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['title']); ?>" /><?php echo $this->_var['lang']['require_field']; ?></td>
      </tr>          
      ...
      <tr>
        ...
        <td><input type="text" class="inputText" name="author" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['author']); ?>" /></td>
      </tr>
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['email']; ?></td>
        <td><input type="text" class="inputText" name="author_email" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['author_email']); ?>" /></td>
      </tr>
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['keywords']; ?></td>
        <td><input type="text" class="inputText" name="keywords" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['keywords']); ?>" /></td>
      </tr>
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['lable_description']; ?></td>
        <td><textarea class="inputText" name="description" id="description" cols="40" rows="5"><?php echo htmlspecialchars($this->_var['article']['description']); ?></textarea></td>
      </tr>
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['external_links']; ?></td>
        <td><input name="link_url" type="text" class="inputText" id="link_url" value="<?php if ($this->_var['article']['link'] != ''): ?><?php echo htmlspecialchars($this->_var['article']['link']); ?><?php else: ?>http://<?php endif; ?>" maxlength="60" /></td>
      </tr>
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['upload_file']; ?></td>
        <td><input type="file" class="inputText" name="file">
          <span class="narrow-label"><?php echo $this->_var['lang']['file_url']; ?>
          <input name="file_url" type="text" class="inputText" value="<?php echo htmlspecialchars($this->_var['article']['file_url']); ?>" size="30" maxlength="255" />
          </span></td>
      </tr>
    </table>
    ...
    <table width="90%" id="goods-table" style="display:none">
      ...
      <td colspan="5">
        ...
        <!-- 关键字 -->
        <input type="text" class="inputText" name="keyword" size="30" />
        <input type="button" value="<?php echo $this->_var['lang']['button_search']; ?>" onclick="searchGoods()" class="buttonBlue" />
      <td>
      </tr>
      <!-- 商品列表 -->
      <tr>
      ...
      <tr>
        ...
        <td align="center">
          <p><input type="button" value="&gt;&gt;" onclick="sz.addItem(true, 'add_link_goods', articleId)" class="buttonBlue" /></p>
          <p><input type="button" value="&gt;" onclick="sz.addItem(false, 'add_link_goods', articleId)" class="buttonBlue" /></p>
          <p><input type="button" value="&lt;" onclick="sz.dropItem(false, 'drop_link_goods', articleId)" class="buttonBlue" /></p>
          <p><input type="button" value="&lt;&lt;" onclick="sz.dropItem(true, 'drop_link_goods', articleId)" class="buttonBlue" /></p>
        </td>
        <td width="45%" align="center">
