...
<tr>
    <td><?php echo $this->_var['lang']['item_name']; ?></td> <td><input type="text" class="inputText" name="item_name" value="<?php echo $this->_var['rt']['item_name']; ?>" id="item_name" size="40" onKeyPress="javascript:key();" /></td>
</tr>
<tr>
    <td><a href="javascript:showNotice('notice_url');" title="<?php echo $this->_var['lang']['notice_url']; ?>"><img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"><?php echo $this->_var['lang']['item_url']; ?></a></td> <td><input type="text" class="inputText" name="item_url" value="<?php echo $this->_var['rt']['item_url']; ?>" id="item_url" size="40" onKeyPress="javascript:key();" /></td>
</tr>
  <tr>
    <td></td>
    <td>
...
<tr>
    <td><?php echo $this->_var['lang']['item_vieworder']; ?></td> <td><input type="text" class="inputText" name="item_vieworder" value="<?php echo $this->_var['rt']['item_vieworder']; ?>" size="40" /></td>
</tr>
<tr>
...
<tr align="center">
  <td colspan="2">
    ...
    <input type="submit" class="buttonBlue" name="Submit"       value="<?php echo $this->_var['lang']['button_submit']; ?>" />
  </td>
</tr>
</table>
</form>
