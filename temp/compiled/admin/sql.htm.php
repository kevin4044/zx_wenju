...
<div class="form-div">
  ...
  <table>
    ...
    <tr><td><textarea class="inputText" name="sql" rows="6" cols="80"><?php echo $this->_var['sql']; ?></textarea></td></tr>
    <tr><td><input type="hidden" name="act" value="query"><input value="<?php echo $this->_var['lang']['query']; ?>" type="submit" class="buttonBlue" /></td></tr>
  </table>
  </form>
</div>
