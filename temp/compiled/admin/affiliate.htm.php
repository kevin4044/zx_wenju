...
<input type="submit" value="<?php echo $this->_var['lang']['button_submit']; ?>" class="buttonBlue" id="btnon"/>
</form>
</div>
<div id="separate">
<div class="form-div">
<form method="post" action="affiliate.php">
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
                ...
                <tr>
                    ...
                    <td><input type="text" class="inputText" name="expire" maxlength="150" size="10" value="<?php echo $this->_var['config']['config']['expire']; ?>" />
                ...
                <tr>
                    ...
                    <td><input type="text" class="inputText" name="level_point_all" maxlength="150" size="10" value="<?php echo $this->_var['config']['config']['level_point_all']; ?>" />
                    <br />
                ...
                <tr>
                    ...
                    <td><input type="text" class="inputText" name="level_money_all" maxlength="150" size="10" value="<?php echo $this->_var['config']['config']['level_money_all']; ?>" />
                    <br />
                ...
                <tr>
                    ...
                    <td><input type="text" class="inputText" name="level_register_all" maxlength="150" size="10" value="<?php echo $this->_var['config']['config']['level_register_all']; ?>" />
                    <br />
                ...
                <tr>
                    ...
                    <td><input type="text" class="inputText" name="level_register_up" maxlength="150" size="10" value="<?php echo $this->_var['config']['config']['level_register_up']; ?>" />
                    <br />
                ...
                <tr><td></td>
                    <td><input type="hidden" name="act" value="updata" /><input type="submit" value="<?php echo $this->_var['lang']['button_submit']; ?>" class="buttonBlue" /></td>
                </tr>
                </tr>
            </table>
    </form>
