...
<table cellspacing="1" cellpadding="3" width="100%">
  <tr>
    ...
    <td><input type="text" class="inputText" name="cat_name" maxlength="60" size = "30" value="<?php echo htmlspecialchars($this->_var['cat']['cat_name']); ?>" /><?php echo $this->_var['lang']['require_field']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      <input type="text" class="inputText" name='sort_order' <?php if ($this->_var['cat']['sort_order']): ?>value='<?php echo $this->_var['cat']['sort_order']; ?>'<?php else: ?> value="50"<?php endif; ?> size="15" />
    </td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td><input type="text" class="inputText" name="keywords" maxlength="60" size="50" value="<?php echo htmlspecialchars($this->_var['cat']['keywords']); ?>" />
  ...
  <tr>
    ...
    <td><textarea class="inputText" name="cat_desc" cols="60" rows="4"><?php echo htmlspecialchars($this->_var['cat']['cat_desc']); ?></textarea></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><br />
      <input type="submit" class="buttonBlue" value="<?php echo $this->_var['lang']['button_submit']; ?>" />
      <input type="reset" class="buttonBlue" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
