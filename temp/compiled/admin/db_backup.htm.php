...
<table cellspacing='1' cellpadding='3' style="margin-top:5px;">
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" class="inputText" name="vol_size" value="<?php echo $this->_var['vol_size']; ?>"></td>
  </tr>
  <tr>
    <td><?php echo $this->_var['lang']['sql_name']; ?></td>
    <td><input type="text" class="inputText" name="sql_file_name" value="<?php echo $this->_var['sql_name']; ?>"></td>
  </tr>
</table>
<input type="hidden" name="act" value="dumpsql">
<div style="text-align:center; margin-top:5px;"><input type="submit" value="<?php echo $this->_var['lang']['start_backup']; ?>" class="buttonBlue" /></div>
</div>
<!-- end  list -->
</form>
