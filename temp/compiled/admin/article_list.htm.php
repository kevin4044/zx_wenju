...
<div class="form-div">
  <form action="javascript:searchArticle()" name="searchForm" >
    ...
    <?php echo $this->_var['lang']['title']; ?> <input type="text" class="inputText" name="keyword" id="keyword" />
    <input type="submit" value="<?php echo $this->_var['lang']['button_search']; ?>" class="buttonBlue" />
  </form>
</div>
...
?>
  <tr>
   ...
   <?php endforeach; else: ?>
    <tr><td class="no-records" colspan="7"><?php echo $this->_var['lang']['no_article']; ?></td></tr>
