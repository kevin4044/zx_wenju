...
<div class="list-div" id="listDiv">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input type="hidden" name = "act" value = "upload_sql"><input type="submit" value=<?php echo $this->_var['lang']['upload_and_exe']; ?> class="buttonBlue"></td>
  </tr>
  </table>
  </form>
...
?>
  ...
  <tr>
    <td colspan=7 align="center"><input type="hidden" name="act" value="remove"><input type="submit" value="<?php echo $this->_var['lang']['submit_remove']; ?>" class="buttonBlue" />
  </tr>
</table>
</from>
</div>
