...
<form enctype="multipart/form-data" action="index.php?act=third" name="theForm" method="post" onsubmit="return validator()" >
  <table cellspacing="1" cellpadding="3" width="100%">
    <tr>
      ...
      <td><input type="text" class="inputText" name="good_category" /></td>
    </tr>
    <tr>
      <td class="micro-label"><?php echo $this->_var['lang']['good_name']; ?>:</td>
      <td><input type="text" class="inputText" name="good_name" /></td>
    </tr>
    <tr>
      <td class="micro-label"><?php echo $this->_var['lang']['good_number']; ?>:</td>
      <td><input type="text" class="inputText" name="good_number" /></td>
    </tr>
    <tr>
      <td class="micro-label"><?php echo $this->_var['lang']['good_brand']; ?>:</td>
      <td><input type="text" class="inputText" name="good_brand" /></td>
    </tr>
    <tr>
      <td class="micro-label"><?php echo $this->_var['lang']['good_price']; ?>:</td>
      <td><input type="text" class="inputText" name="good_price" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><textarea class="inputText" name="good_brief" cols="40" rows="3"></textarea></td></td>
    </tr>
    <tr>
      <td class="micro-label"><?php echo $this->_var['lang']['good_image']; ?>:</td>
      <td><input type="file" class="inputText" name="goods_img" /></td>
    </tr>
    <tr>
      <td></td>
      <td>
        <input type="submit" value=<?php echo $this->_var['lang']['next_step']; ?> class="buttonBlue" />
        <input type="button" value=<?php echo $this->_var['lang']['skip']; ?> onclick="javascript:window.location.href='index.php?act=main'" class="buttonBlue" />
      </td>
    </tr>
  </table>
</form>
