...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      <tr>
        ...
        <td>
          <input type='text' name='cat_name' maxlength="20" value='<?php echo htmlspecialchars($this->_var['cat_info']['cat_name']); ?>' size='27' class="inputText" /> <font color="red">*</font>
        </td>
      </tr>
      <tr>
      ...
      <tr id="measure_unit">
        ...
        <td>
          <input type="text" class="inputText" name='measure_unit' value='<?php echo $this->_var['cat_info']['measure_unit']; ?>' size="12" />
        </td>
      </tr>
      <tr>
        <td class="label"><?php echo $this->_var['lang']['sort_order']; ?>:</td>
        <td>
          <input type="text" class="inputText" name='sort_order' <?php if ($this->_var['cat_info']['sort_order']): ?>value='<?php echo $this->_var['cat_info']['sort_order']; ?>'<?php else: ?> value="50"<?php endif; ?> size="15" />
        </td>
      </tr>
...
?>
      ...
      <tr>
        ...
        <td>
          <input type="text" class="inputText" name="grade" value="<?php echo empty($this->_var['cat_info']['grade']) ? '0' : $this->_var['cat_info']['grade']; ?>" size="40" /> <br />
      ...
      <tr>
        ...
        <td>
          <input type="text" class="inputText" name="style" value="<?php echo htmlspecialchars($this->_var['cat_info']['style']); ?>" size="40" /> <br />
      ...
      <tr>
        ...
        <td><input type="text" class="inputText" name="keywords" value='<?php echo $this->_var['cat_info']['keywords']; ?>' size="50">
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <textarea class="inputText" name='cat_desc' rows="6" cols="48"><?php echo $this->_var['cat_info']['cat_desc']; ?></textarea>
        </td>
      </tr>
      </table>
