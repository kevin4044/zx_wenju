      <tr>
        ...
        <td>
          ...
          <input name="value[<?php echo $this->_var['var']['id']; ?>]" type="text" class="inputText" value="<?php echo $this->_var['var']['value']; ?>" size="40" />
          ...
          <textarea class="inputText" name="value[<?php echo $this->_var['var']['id']; ?>]" cols="40" rows="5"><?php echo $this->_var['var']['value']; ?></textarea>
...
?>
            ...
            <table>
              ...
              <tr>
                <td><input name="invoice_type[]" type="text" class="inputText" value="<?php echo $this->_var['cfg']['invoice_type']['type']['0']; ?>" /></td>
                <td><input name="invoice_rate[]" type="text" class="inputText" value="<?php echo $this->_var['cfg']['invoice_type']['rate']['0']; ?>" /></td>
              </tr>
              <tr>
                <td><input name="invoice_type[]" type="text" class="inputText" value="<?php echo $this->_var['cfg']['invoice_type']['type']['1']; ?>" /></td>
                <td><input name="invoice_rate[]" type="text" class="inputText" value="<?php echo $this->_var['cfg']['invoice_type']['rate']['1']; ?>" /></td>
              </tr>
              <tr>
                <td><input name="invoice_type[]" type="text" class="inputText" value="<?php echo $this->_var['cfg']['invoice_type']['type']['2']; ?>" /></td>
                <td><input name="invoice_rate[]" type="text" class="inputText" value="<?php echo $this->_var['cfg']['invoice_type']['rate']['2']; ?>" /></td>
              </tr>
            </table>
            <?php endif; ?>
          <?php endif; ?>
