<!-- $Id: start.htm 17216 2011-01-19 06:03:12 -->
...
<table cellspacing='1' cellpadding='3'>
  ...
  <tr>
    <td><?php echo $this->_var['lang']['xak_version']; ?></td>
    <td><?php echo $this->_var['xak_version']; ?> RELEASE <?php echo $this->_var['xak_release']; ?></td>
    <td><?php echo $this->_var['lang']['install_date']; ?></td>
    <td><?php echo $this->_var['install_date']; ?></td>
  </tr>
  <tr>
    <td><?php echo $this->_var['lang']['ec_charset']; ?></td>
    <td><?php echo $this->_var['xak_charset']; ?></td>
    <td></td>
    <td></td>
  </tr>
</table>
