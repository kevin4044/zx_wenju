...
<?php echo $this->smarty_insert_scripts(array('files'=>'common2.js,json2.js,global.js,compare.js')); ?>
</head>
<body>
...
?>
			...
			<?php endif; ?>
			<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_85456600_1381635437');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_85456600_1381635437']):
?>
      <div class="screeBox">
			<strong><?php echo htmlspecialchars($this->_var['filter_attr_0_85456600_1381635437']['filter_attr_name']); ?> :</strong>
			<?php $_from = $this->_var['filter_attr_0_85456600_1381635437']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
