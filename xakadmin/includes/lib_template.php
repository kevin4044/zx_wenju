...
///* 插件的 library */
//$sql = 'SELECT code, library FROM ' . $xak->table('plugins') . " WHERE assign = 1 AND library > ''";
//$res = $db->query($sql);
//
...
{
    $sql = 'SELECT code, library FROM ' . $GLOBALS['xak']->table('plugins') . " WHERE library > ''";
