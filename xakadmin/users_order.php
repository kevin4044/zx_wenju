 ...
 */
 ...
 {
    global $db, $xak, $start_date, $end_date;
    ...
    $sql = "SELECT count(distinct(u.user_id)) FROM " .$xak->table('users')." AS u, ".$xak->table('order_info')." AS o " .$where;
    ...
    $sql = "SELECT u.user_id, u.user_name, COUNT(*) AS order_num, " .$total_fee.
               "FROM ".$xak->table('users')." AS u, ".$xak->table('order_info')." AS o " .$where .
