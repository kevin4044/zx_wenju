...
if ($_REQUEST['act'] == 'insert')
{
    ...
    /* 插入数据 */
    $add_time = gmtime();
    $sql = "INSERT INTO ".$xak->table('article')."(title, cat_id, content, add_time) VALUES('$_POST[title]', '0', '$_POST[FCKeditor1]','$add_time' )";
    $db->query($sql);
...
if ($_REQUEST['act'] == 'edit')
{
    ...
    /* 取得文章数据 */
    $sql = "SELECT article_id, title, content FROM ".$xak->table('article')."WHERE article_id =".$_REQUEST['id'];
