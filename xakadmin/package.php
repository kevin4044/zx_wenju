...
if ($_REQUEST['act'] == 'add')
{
    ...
    $sql = "DELETE FROM " .$xak->table('package_goods') .
...
elseif ($_REQUEST['act'] =='update')
{
    ...
    $db->autoExecute($xak->table('goods_activity'), $record, 'UPDATE', "act_id = '" . $_POST['id'] . "' AND act_type = " . GAT_PACKAGE );
...
elseif ($_REQUEST['act'] == 'add_package_goods')
{
    ...
    foreach ($fittings AS $val)
    {
        ...
        $sql = "INSERT INTO " . $xak->table('package_goods') . " (package_id, goods_id, product_id, goods_number, admin_id) " .
...
{
    $sql = "UPDATE " . $GLOBALS['xak']->table('package_goods') . " SET " .
