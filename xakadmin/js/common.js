/* $File: common.js 4824 2007-01-31 08:23:56Z paulgao $ */
...
function checkOrder()
{
  var lastCheckOrder = new Date(document.getCookie('XAK_LastCheckOrder'));
  var today = new Date();

  if (lastCheckOrder == null || today-lastCheckOrder >= NEW_ORDER_INTERVAL)
  {
    document.setCookie('XAK_LastCheckOrder', today.toGMTString());
    try
    {
