...
/** 供货商商品管理程序
 * ----------------------------------------------------------------------------
 * $File: goods.php 16345 2009-06-24 09:36:23
*/
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if ((isset($_POST['attr_id_list']) && isset($_POST['attr_value_list'])) || (empty($_POST['attr_id_list']) && empty($_POST['attr_value_list'])))
    {
        ...
        $sql = "SELECT * FROM " . $xak->table('goods_attr') . " WHERE goods_id = '$goods_id'";
...
elseif ($_REQUEST['act'] == 'drop_goods_article')
{
    ...
    $sql = "DELETE FROM " .$xak->table('goods_article') . " WHERE " . db_create_in($articles, "article_id");
    $db->query($sql);
