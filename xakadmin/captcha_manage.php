...
if ($_REQUEST['act'] == 'save_config')
{
    ...
    $sql = "UPDATE " . $xak->table('shop_config') . " SET value='$captcha' WHERE code='captcha'";
    $db->query($sql);
    $sql = "UPDATE " . $xak->table('shop_config') . " SET value='$captcha_width' WHERE code='captcha_width'";
    $db->query($sql);
    $sql = "UPDATE " . $xak->table('shop_config') . " SET value='$captcha_height' WHERE code='captcha_height'";
    $db->query($sql);
