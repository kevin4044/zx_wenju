/* $File: shopping_flow.js 4865 2007-01-31 14:04:10Z paulgao $ */
...
function selectShipping(obj)
{
  ...
  {
    document.getElementById('XAK_NEEDINSURE').checked = false;
    document.getElementById('XAK_NEEDINSURE').disabled = true;
  }
  else
  {
    document.getElementById('XAK_NEEDINSURE').checked = false;
    document.getElementById('XAK_NEEDINSURE').disabled = false;
  }
...
function orderShippingSelectedResponse(result)
{
  if (result.need_insure)
  {
    try
    {
      document.getElementById('XAK_NEEDINSURE').checked = true;
    }
    catch (ex)
    {
      alert(ex.message);
  ...
  try
  {
    if (document.getElementById('XAK_CODFEE') != undefined)
    {
      document.getElementById('XAK_CODFEE').innerHTML = result.cod_fee;
    }
  }
  catch (ex)
  {
...
function orderSelectedResponse(result)
{
  ...
  try
  {
    var layer = document.getElementById("XAK_ORDERTOTAL");
...
function changeSurplusResponse(obj)
{
  if (obj.error)
  {
    try
    {
      document.getElementById("XAK_SURPLUS_NOTICE").innerHTML = obj.error;
      document.getElementById('XAK_SURPLUS').value = '0';
      document.getElementById('XAK_SURPLUS').focus();
    }
    catch (ex) { }
  }
  else
  {
    try
    {
      document.getElementById("XAK_SURPLUS_NOTICE").innerHTML = '';
    }
    catch (ex) { }
...
function changeIntegralResponse(obj)
{
  if (obj.error)
  {
    try
    {
      document.getElementById('XAK_INTEGRAL_NOTICE').innerHTML = obj.error;
      document.getElementById('XAK_INTEGRAL').value = '0';
      document.getElementById('XAK_INTEGRAL').focus();
    }
    catch (ex) { }
  }
  else
  {
    try
    {
      document.getElementById('XAK_INTEGRAL_NOTICE').innerHTML = '';
    }
    catch (ex) { }
    orderSelectedResponse(obj.content);
  }
...
function changeBonusResponse(obj)
{
  if (obj.error)
  {
    ...
    try
    {
      document.getElementById('XAK_BONUS').value = '0';
    }
    catch (ex) { }
  }
  else
...
if (obj.error)
  {
    ...
    try
    {
      document.getElementById('XAK_BONUSN').value = '0';
    }
    catch (ex) { }
  }
  else
...
{
  var obj        = document.getElementById('XAK_NEEDINV');
  var objType    = document.getElementById('XAK_INVTYPE');
  var objPayee   = document.getElementById('XAK_INVPAYEE');
  var objContent = document.getElementById('XAK_INVCONTENT');
...
function checkOrderForm(frm)
{
  ...
  // 检查用户输入的余额
  if (document.getElementById("XAK_SURPLUS"))
  {
    var surplus = document.getElementById("XAK_SURPLUS").value;
    ...
    if (error)
    {
      try
      {
        document.getElementById("XAK_SURPLUS_NOTICE").innerHTML = error;
      }
      catch (ex)
      {
      }
  ...
  // 检查用户输入的积分
  if (document.getElementById("XAK_INTEGRAL"))
  {
    var integral = document.getElementById("XAK_INTEGRAL").value;
    ...
    if (error)
    {
      ...
      try
      {
        document.getElementById("XAK_INTEGRAL_NOTICE").innerHTML = error;
      }
      catch (ex)
      {
      }
