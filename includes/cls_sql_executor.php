...
class sql_executor
{
     ...
     * @return  void
     */
    function __construct($db, $charset = 'gbk', $sprefix = 'xsp_', $tprefix = 'xsp_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
     ...
     * @return  void
     */
    function sql_executor($db, $charset = 'gbk', $sprefix = 'xsp_', $tprefix = 'xsp_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
        $this->db = $db;
