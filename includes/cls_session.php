...
class cls_session
{
    ...
    function __construct(&$db, $session_table, $session_data_table, $session_name = 'XAK_ID', $session_id = '')
    {
        $this->cls_session($db, $session_table, $session_data_table, $session_name, $session_id);
    }

    function cls_session(&$db, $session_table, $session_data_table, $session_name = 'XAK_ID', $session_id = '')
    {
    ...
    function destroy_session()
    {
        ...
        if (!empty($GLOBALS['xak']))
        {
            $this->db->query('DELETE FROM ' . $GLOBALS['xak']->table('cart') . " WHERE session_id = '$this->session_id'");
        }
