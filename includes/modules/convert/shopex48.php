...
class shopex48
{
    ...
    function process_brand()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $brand = array(
                ...
                'brand_desc' => '',
                'site_url' => xak_iconv($this->scharset, $this->tcharset, addslashes($row['brand_url'])),
    ...
    function process_users()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $user['user_name']      = xak_iconv($this->scharset, $this->tcharset, addslashes($row['uname']));
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $address['address']         = xak_iconv($this->scharset, $this->tcharset, addslashes($row['addr']));
    ...
    function process_article()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $article['content']     = xak_iconv($this->scharset, $this->tcharset, addslashes($row['content']));
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $link['link_name']   = xak_iconv($this->scharset, $this->tcharset, addslashes($row['link_name']));
    ...
    function process_order()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $order['consignee']         = xak_iconv($this->scharset, $this->tcharset, addslashes($row['consignee']));
            $order['address']           = xak_iconv($this->scharset, $this->tcharset, addslashes($row['ship_addr']));
            ...
            $order['shipping_name']     = xak_iconv($this->scharset, $this->tcharset, addslashes($row['ship_name']));
            $order['pay_name']          = xak_iconv($this->scharset, $this->tcharset, addslashes($row['shipping']));
            $order['inv_payee']         = xak_iconv($this->scharset, $this->tcharset, addslashes($row['tax_company']));
    ...
    function process_config()
    {
        ...
        $config = array();
        //$config['shop_name']        = xak_iconv($this->scharset, $this->tcharset, addslashes($store_arr[0]);
        //$config['shop_title']       = xak_iconv($this->scharset, $this->tcharset, addslashes($store_arr[0]));
        //$config['shop_desc']        = xak_iconv($this->scharset, $this->tcharset, addslashes($store_arr[1]));
        //$config['shop_address']     = xak_iconv($this->scharset, $this->tcharset, addslashes($row['store']));
