        ...
        else
        {
            ...
            while (!feof($fp))
            {
                ...
                if (strcmp($res, 'VERIFIED') == 0)
                {
                    ...
                    /*$sql = "SELECT COUNT(*) FROM " . $GLOBALS['xak']->table('order_action') . " WHERE action_note LIKE '" . mysql_like_quote($txn_id) . "%'";
                    ...
                    $sql = "SELECT order_amount FROM " . $GLOBALS['xak']->table('pay_log') . " WHERE log_id = '$order_sn'";
