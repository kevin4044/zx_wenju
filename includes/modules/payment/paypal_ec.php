...
/** paypal快速结帐
 * ----------------------------------------------------------------------------
 * $File: paypal_ec.php 16489 2009-08-03 10:14:03Z liuhui $
 */
...
class paypal_ec
{
    ...
    function get_code($order, $payment)
    {
        ...
        $nvpstr="&Amt=".$paymentAmount."&PAYMENTACTION=".$paymentType."&ReturnUrl=".$returnURL."&CANCELURL=".$cancelURL ."&CURRENCYCODE=".$currencyCodeType ."&ButtonSource=XKASHOP_cart_EC_C2";
