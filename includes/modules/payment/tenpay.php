...
class tenpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        /* 编码标准 */
        if (!defined('XAK_CHARSET') || XAK_CHARSET == 'utf-8')
        {
            $desc = xak_iconv('utf-8', 'gbk', $desc);
        }
        ...
        $parameter = array(
            ...
            'sys_id'            => '542554970',                 //xakshop C账号 不参与签名
        ...
        $button  .= '<input type="image" src="'. $GLOBALS['xak']->url() .'images/tenpay.gif" value="' .$GLOBALS['_LANG']['pay_button']. '" /></form><br />';
