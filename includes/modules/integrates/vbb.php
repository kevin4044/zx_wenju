...
class vbb extends integrate
{
    ...
    function set_cookie ($username="")
    {
        ...
        else
        {
            ...
            {
                $username = xak_iconv('UTF8', $this->charset, $username);
            }
    ...
    function check_cookie ()
    {
        ...
        if ($this->charset != 'UTF8')
        {
            $row['user_name'] = xak_iconv($this->charset, 'UTF8', $row['user_name']);
        }
    ...
    function check_user($username, $password = null)
    {
        if ($this->charset != 'UTF8')
        {
            $post_username = xak_iconv('UTF8', $this->charset, $username);
        }
        else
        {
